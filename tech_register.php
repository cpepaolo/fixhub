...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (mysqli_num_rows($check) > 0) {
        ...
        $sql = "INSERT INTO users (name, email, password, phone, role) 
                VALUES ('$name', '$email', '$password', '$phone', 'technician')";
        if (mysqli_query($conn, $sql)) {
            $user_id = mysqli_insert_id($conn);
            $sql2 = "INSERT INTO technicians (user_id, skill, location, bio) 
                     VALUES ('$user_id', '$skill', '$location', '$bio')";
            mysqli_query($conn, $sql2);
            $success = "Technician account created! You can now login.";
        }
    }
}
?>
...
<title>FixHub — Technician Register</title>
...
<div class="container">
    ...
    <div class="card">
        <div class="card-header">
            <h2>Join as Technician</h2>
            <p>Register your technician account to receive bookings</p>
        </div>
        ...
        <form method="POST">
            ...
            <div class="form-group">
                ...
                <div class="input-wrap">
                    ...
                    <input type="text" name="location" placeholder="San Pablo City, Laguna" required/>
                </div>
            </div>
            <div class="form-group">
                <label>Short Bio</label>
                <textarea name="bio" placeholder="Tell customers about your experience..."></textarea>
            </div>
            <div class="form-group">
            ...
            <button type="submit" class="btn">Register as Technician</button>
        </form>
        <?php endif; ?>
